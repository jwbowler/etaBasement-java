...
class RangeSliderUI extends BasicSliderUI {
    ...
    private Color lowThumbDraw = Color.WHITE;
    private Color lowThumbFill = Color.WHITE;
    ...
    private void paintLowerThumb(Graphics g) {
        ...
        g2d.setColor(lowThumbFill);
        g2d.fill(thumbShape);

        g2d.setColor(lowThumbDraw);
        g2d.draw(thumbShape);
    ...
    private void paintUpperThumb(Graphics g) {
        ...
        g2d.setColor(upThumbFill);
        g2d.fill(thumbShape);

        g2d.setColor(upThumbDraw);
        g2d.draw(thumbShape);
